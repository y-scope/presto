...
public class TestClpMetadata
{
    ...
    public void testGetTable1Metadata()
    {
        ...
        columnMetadata.add(ColumnMetadata.builder().setName("a").setType(IntegerType.INTEGER).setNullable(true).build());
        columnMetadata.add(ColumnMetadata.builder().setName("b").setType(DoubleType.DOUBLE).setNullable(true).build());
        columnMetadata.add(ColumnMetadata.builder().setName("c.d").setType(BooleanType.BOOLEAN).setNullable(true).build());
        columnMetadata.add(ColumnMetadata.builder().setName("c.e").setType(VarcharType.VARCHAR).setNullable(true).build());
        columnMetadata.add(ColumnMetadata.builder().setName("a").setType(VarcharType.VARCHAR).setNullable(true).build());
        columnMetadata.add(ColumnMetadata.builder().setName("b").setType(VarcharType.VARCHAR).setNullable(true).build());
