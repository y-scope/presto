...
import com.facebook.presto.plugin.clp.ClpConnectorFactory;
        ...
        extends TestClpQueryBase
{
    ...
    public void setUp()
    {
        ...
        localQueryRunner.getMetadata().registerBuiltInFunctions(FunctionExtractor.extractFunctions(new ClpPlugin().getFunctions()));
