...
SystemConfig::SystemConfig() {
  registeredProps_ =
      std::unordered_map<std::string, folly::Optional<std::string>>{
          ...
          NUM_PROP(kQueryMemoryGb, 4),
          NUM_PROP(kQueryReservedMemoryGb, 1),
